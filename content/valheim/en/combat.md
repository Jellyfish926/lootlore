...
slug: "combat"
url: "/valheim/combat/"
title: "Valheim Combat Basics: Block and Dodge"
seoTitle: "Valheim Combat Basics: Block and Dodge | Valheim Guide"
description: "Learn Valheim combat in a practisable order: why a raised shield still lets damage through, why stamina matters most, and how to pick your main weapon."
...
## Food is part of your defence

Your maximum health affects how much stagger you can absorb; see [Stagger](https://valheim.fandom.com/wiki/Stagger). So if a new shield still leaves you getting broken through, the shield is not automatically the problem — check food, current stamina and what you are fighting at the same time.

Do not assume someone else's successful parry will work for you under different conditions. Check the difficulty, gear quality and food, then try to reproduce it. Starred enemies in particular are a poor choice for eating the first hit on instinct.

## Keep stamina for the exit

Throw one short combo at a time, and confirm you can still move or dodge before continuing. When an enemy is knocked back, you do not have to chase it; it has stepped out of range, which is exactly the time to recover and look for other threats.

Against several enemies, try to keep them in roughly the same direction, and do not back up blindly into new terrain. Steps, slopes and narrow doorways all change how your attacks feel; moving onto flat ground is sometimes more effective than changing weapon.

## Pick one main weapon you know, then cover the gaps
