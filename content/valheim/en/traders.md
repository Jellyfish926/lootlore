...
slug: "traders"
url: "/valheim/traders/"
title: "Valheim Traders: Haldor, Hildir, Bog Witch"
seoTitle: "Valheim Traders: Haldor, Hildir, Bog Witch | Valheim Guide"
description: "What each of the three traders is for, how to search for them and set up return routes, and why 1.0 inventory slots and carry weight are not the same."
...
## How to widen the search when you cannot find one

Terrain and candidate locations differ between worlds, so nobody can promise that walking in one direction from spawn will find a trader. Fold the search into normal exploration: sail along new coastlines and toward the regions you were heading to anyway, log the routes you have covered, and plan a landing once you see the icon.

If you decide to use an external seed map, accept that it may spoil the terrain for you, and confirm the tool supports the current world generation version. Results from an older tool are not a guarantee for a 1.0 world. Above all, do not sail your only ship into a region you cannot handle just to verify a coordinate.

## Inventory slots and carry weight are different
