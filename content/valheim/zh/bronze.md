...
探索墓室是早期取得焰灵之核的常见方式。核心同时会被生产设施和交通建设消耗，不能只看某一个配方需要多少。详情参照[焰灵之核](https://valheim.fandom.com/wiki/Surtling_core)。第一次搜到材料后，先解决让矿变成可用金属的设施，再规划传送门。

燃料也属于生产成本。建议给木材、煤和矿石单独留箱位，出门采矿前顺手检查库存。只计算挖矿时间，却不准备燃料，会让回家后的加工完全停下来。
...
有足够应对黑暗林山的主力装备，拥有稳定食物与修理条件，并且能携带召唤材料到达古树长老祭坛，就可以准备下一阶段。把当前所有装备升满不是主线强制要求。

但不要把剩余基础材料全用完。后面仍会需要工具、建造和交通资源。留下一份可修复基地、补建交通的储备，再带着明确目的离开青铜阶段，会比清空仓库换一件很少使用的武器更稳妥。

## 第一条生产线的材料速查

| 目标 | 基础材料 | 作用 |
| --- | --- | --- |
| 木炭窑 | 20 石头、5 焰灵之核 | 把木材加工为煤 |
| 熔炉 | 20 石头、5 焰灵之核 | 将对应原矿熔炼 |
| 锻造台 | 4 石头、4 煤、10 木头、6 铜 | 合金与金属装备制作 |
| 1 青铜 | 2 铜、1 锡 | 在锻造台制作，不是直接把两种矿石放进普通熔炉 |

材料分别参照[木炭窑](https://valheim.fandom.com/wiki/Charcoal_kiln)、[熔炉](https://valheim.fandom.com/wiki/Smelter)、[锻造台](https://valheim.fandom.com/wiki/Forge)和[青铜](https://valheim.fandom.com/wiki/Bronze)。这些是基础建设与单次合金量，不包含附属升级件及后续装备开支。

## 接下来可以看

- [英灵神殿制作与修理指南：配方不显示、等级不足怎么排查](/valheim/zh/crafting/)
