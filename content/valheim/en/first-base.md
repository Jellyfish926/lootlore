...
title: "Valheim Base Building: Your First Base"
seoTitle: "Valheim Base Building: Your First Base | Valheim Guide"
description: "How to build your first practical Valheim base: picking a site, roofing, venting smoke, structural stability, production layout and emergency supplies."
...
## Choose a site for hauling and for growth
...
## Lay out rooms around how items move

Put an unloading chest near the entrance, raw materials and fuel near the processing gear, ingredients and seeds near the kitchen, and travel supplies by the portal. Naming each chest by purpose is far easier to maintain than sorting everything by colour or looks. A shared base can also use a "to sort" area so someone who just got back can dump their load safely.

Keep late-game equipment that heats up, throws sparks or can damage its surroundings away from the living area. When you upgrade a production line, run it in a separate space first, then decide whether it belongs in the main building.

## Keep one rescue corner nobody raids

Stock it with spare food, resistance supplies, old gear and enough building material to matter, and keep it separate from the everyday storage. Put the bed and a portal somewhere easy to reach, so one raid cannot cut off every way out at once. No amount of solid building replaces a planned retreat and a restock. Get the base reliably serving your expeditions first, then grow it into whatever you want it to look like.
