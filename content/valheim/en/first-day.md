...
title: "Valheim First Day: Survive Night One"
seoTitle: "Valheim First Day: Survive Night One | Valheim Guide"
description: "A clear Valheim opening route for tools, shelter, food and a bed on day one, plus the jobs that are not worth rushing before your first night."
...
## What to gather after you spawn
...
## Aim for steady food, not fancy food

Collect the berries, mushrooms and meat you can reach, learn to cook, and try to get all three food slots doing something. Do not wander off while meat is on the fire; coming back to a burnt piece wastes the whole hunt. Food mainly raises your health and stamina ceilings rather than acting as a starvation timer, as covered in the [official FAQ](https://www.valheimgame.com/faq/).

Split what you eat now from what you are taking out tomorrow. You do not need to carry every material you find. Put the loot you do not need in a chest and keep your pack free for exploring.

## Do one last check before dark

Repair the tools you are using, make sure the fire is still lit, confirm the bed works, and clear the doorway. Put food somewhere you can find it, and note the resources and odd landmarks nearby. The only jobs still worth doing now are short gathering trips; anything clearly away from home waits until tomorrow.

By the end of day one you do not need copper, nice furniture or a full gear set. A house that works, a route home you know, and a spare ration is a fine start. Practise shield and bow next, collect deer trophies, and get ready for Eikthyr.

## Minimum starting tool materials

| Item | Base materials | Problem it solves |
| --- | --- | --- |
| Hammer | 3 Wood, 2 Stone | Lets you start building |
| Workbench | 10 Wood | Basic crafting and repairing the matching tools |

Recipes are on the [Crafting](https://valheim.fandom.com/wiki/Crafting) and [Building](https://valheim.fandom.com/wiki/Building) pages. This table does not include materials for roofs, walls or a bed, so do not treat ten wood as the budget for a whole house.
